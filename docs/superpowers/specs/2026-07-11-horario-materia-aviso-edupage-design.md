...
> **Status:** superseded parcialmente por `2026-07-11-planejar-hoje-design.md` (aba Semana removida).

## Objetivo

Na tela Curso, mostrar dia e horário de cada matéria (`Seg 18:50–22:25`). Em telas com horários (Curso, Hoje, Planejar, Config), avisar que os dados vêm do EdUpage e erros são da fonte institucional.
...
- `variant="compacto"`: Curso, Hoje, Planejar
...
- Hoje / Planejar: abaixo de `Titulo`
